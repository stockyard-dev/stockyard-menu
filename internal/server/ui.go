...
const dashHTML = `<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>Menu</title>
...
<div class="hdr"><h1><span>&#9670;</span> MENU</h1><button class="btn btn-p" id="add-btn">+ Add</button></div>
<div class="main"><div class="tabs" id="tabs"><div class="tab active" onclick="switchTab('categories')">Categories</div><div class="tab" onclick="switchTab('items')">Menu Items</div></div><div class="tab-content active" id="tab-categories">
<div class="stats" id="stats-categories"></div>
<div class="toolbar">
<input class="search" id="search-categories" placeholder="Search..." oninput="renderRes('categories')"></div>
<div class="count-label" id="count-categories"></div>
<div class="tbl-wrap"><table class="tbl"><thead><tr><th>Category Name</th><th>Sort Order</th><th>Active</th><th></th></tr></thead><tbody id="tbody-categories"></tbody></table></div></div><div class="tab-content" id="tab-items">
<div class="stats" id="stats-items"></div>
<div class="toolbar">
<input class="search" id="search-items" placeholder="Search..." oninput="renderRes('items')"></div>
<div class="count-label" id="count-items"></div>
<div class="tbl-wrap"><table class="tbl"><thead><tr><th>Item Name</th><th>Category</th><th>Description</th><th>Price ($)</th><th>Image URL</th><th>Dietary Info</th><th>Available</th><th>Featured</th><th></th></tr></thead><tbody id="tbody-items"></tbody></table></div></div></div><div class="modal-bg" id="mbg" onclick="if(event.target===this)closeModal()"><div class="modal" id="mdl"></div></div><script>var A="/api",data={},editId=null,activeRes="categories";var resCfg={"categories":{d:"Categories",f:[{n:"name",l:"Category Name",t:"text",r:true,o:[]},{n:"sort_order",l:"Sort Order",t:"integer",r:false,o:[]},{n:"active",l:"Active",t:"checkbox",r:false,o:[]}]},"items":{d:"Menu Items",f:[{n:"name",l:"Item Name",t:"text",r:true,o:[]},{n:"category",l:"Category",t:"text",r:false,o:[]},{n:"description",l:"Description",t:"textarea",r:false,o:[]},{n:"price",l:"Price ($)",t:"number",r:true,o:[]},{n:"image_url",l:"Image URL",t:"url",r:false,o:[]},{n:"dietary",l:"Dietary Info",t:"text",r:false,o:[]},{n:"available",l:"Available",t:"checkbox",r:false,o:[]},{n:"featured",l:"Featured",t:"checkbox",r:false,o:[]}]},};
